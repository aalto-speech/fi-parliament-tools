...
if [ $# -ne 2 ]; then
	...
	echo "the decoding and segmentation part. BE aware that you need the slash at the end"
	echo "of the <from_dir> parameter because of rsync!"
	echo
	exit 1
fi
...
# -u prevents overwrite of files that have been changed at remote
# -v verbose output
