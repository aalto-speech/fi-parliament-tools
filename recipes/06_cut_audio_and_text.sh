...
if [ $# -ne 3 ]; then
    ...
    echo "e.g.: $0 generated/new_data generated/new_data/segments 200000"
    echo
    echo "This script cuts the segments in <kaldi_dir> to individual wav-files, gets the"
    echo "text, and writes the sample pairs into <output_dir>. The script will cut the"
...
for part_file in $INPUT/segments_part_*
do
